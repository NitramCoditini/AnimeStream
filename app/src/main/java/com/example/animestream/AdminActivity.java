...
public class AdminActivity extends AppCompatActivity {
    ...
    private void uploadImageFirebase(Uri contentUri) {
        ...
        StorageReference image = storageReference.child(" image movies/" + System.currentTimeMillis() + "." + getFileExt(contentUri));
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                image.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        Toast.makeText(AdminActivity.this, "Image is uploaded", Toast.LENGTH_SHORT).show();
                        String description = desc.getText().toString().trim();
                        String genre = gen.getText().toString().trim();



                        MovieDetail foodDetail = new MovieDetail(uri.toString(),description,genre);
                        String imageId = databaseReference.push().getKey();
                        databaseReference.child(imageId).setValue(foodDetail);
                        Toast.makeText(AdminActivity.this, "Data inserted", Toast.LENGTH_SHORT).show();
